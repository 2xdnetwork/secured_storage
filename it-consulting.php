                     ...
                     <div class="row wow slideInLeft">
                        <div class="col-lg-12">
                           <div class="about-page-banner-title">
                              <h1>IT Consulting</h1>
                              <p class="mb-0">Together We Can Run Your Business Smarter. Enterprise-level It Services With Small-business Prices.</p>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="Effective-con w-100 service-Effective-tabs-con">
            <div class="container overlay-content">
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <ul class="mb-0 list">
                           ...
                           <li><i class="fas fa-check-circle"></i>Secure VPN management</li>
                           <li><i class="fas fa-check-circle"></i>Secure remote access</li>
                           <li><i class="fas fa-check-circle"></i>Network device management </li>
                           <li><i class="fas fa-check-circle"></i>Desktop management</li>
                           <li><i class="fas fa-check-circle"></i>Firewall advance management (Next Generation)</li>
                        </ul>
                     </div>
                     </div>
                  </div>
               ...
               <div class="tabs-content mt-5 mb-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        <h3>It Proactive Monitoring</h3>
                        <div class="informationmain-right-content">
                        <p>Our IT Proactive Monitoring will protect your IT infrastructure by identifying potential issues within IT infrastructure and applications before users/clients notice and complain and initiating actions to avoid the issue from becoming user noticeable and business impacting.</p>
                     </div>
                     </div>
                  </div>
               </div>
