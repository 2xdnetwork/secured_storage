...
<html lang="zxx"> 
   ...
   <head>  
      ...
      <title>IT Consulting | Secured Storage</title>
   </head>
   <body>
                     ...
                     <div class="row wow slideInLeft">
                        <div class="col-lg-12">
                           <div class="about-page-banner-title">
                              <h1>Contact Us</h1>
                              <p class="mb-0">If you have any questions or comments, please contact us via 
email or phone, or send us a message using the contact form.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                           <div class="Effective-sec-item mb-lg-0 mb-md-0 mb-4">
                              ...
                              <div class="Effective-sec-item-title">
                                 ...
                                 <p class="mb-0">8242 W 3rd St. Suite 302 <br>Los Angeles, CA 90048</p>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
                           <div class="Effective-sec-item mb-lg-0 mb-md-0 mb-4">
                              ...
                              <div class="Effective-sec-item-title">
                                 ...
                                 <p class="mb-0">(424) 281-7185</p>
                                 <p class="mb-0">Monday–Friday 9am-7pm</p>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
